...
client = MongoClient("mongodb://api:PASSWORD@MONGOADDR:PORT,OTHER-SERVER:PORT,OTHER-SERVER:PORT/rpg-db?ssl=true&replicaSet=atlas-6e05a9-shard-0&authSource=admin&retryWrites=true&w=majority")
db = client["rpg-db"]

authToken = "Your own token that corresponds to the one you set on the bot"
